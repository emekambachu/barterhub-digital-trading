...
@section('content')
    <div class="corzo-page-title-wrap corzo-style-custom corzo-left-align">
        ...
        <div class="corzo-page-title-container corzo-container">
            <div class="corzo-page-title-content corzo-item-pdlr">
                <div class="corzo-page-caption">Our Contact</div>
                <h1 class="corzo-page-title">Contact</h1>
    ...
    <div class="gdlr-core-pbf-wrapper" style="padding: 30px 0px 20px 0px;" data-skin="Contact link">
        <div class="gdlr-core-pbf-background-wrap" style="background-color: #d32525;">
            <div class="gdlr-core-pbf-background gdlr-core-parallax gdlr-core-js"
                 style="opacity: 0.14; background-image: url(&quot;{{ asset('main/upload/QAdTsSj8TOOWzlyLn3Rg_14248396556_aefcd9a926_o.jpg') }}&quot;);
                 background-size: cover; background-position: center center; height: 518.306px; transform: translate(0px, -82.5px);" data-parallax-speed="0.2"></div>
        </div>
        <div class="gdlr-core-pbf-wrapper-content gdlr-core-js">
            <div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">

                <div class="gdlr-core-pbf-column gdlr-core-column-20 gdlr-core-column-first" id="gdlr-core-column-2464">
                        ...
                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8" style="">
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align" style="padding-bottom: 40px;">
                                    <div class="gdlr-core-icon-item-wrap gdlr-core-skin-e-background gdlr-core-icon-item-type-round" style="background-color: #d34747; border-radius: 40px; -moz-border-radius: 40px; -webkit-border-radius: 40px; padding: 20px 20px 20px 20px;">
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 25px;">
                                    ...
                                    <h3 class="gdlr-core-title-item-title gdlr-core-skin-title"
                                        style="font-size: 26px; letter-spacing: 0px; text-transform: none; color: #fff;">
                                ...
                                <div class="gdlr-core-divider-item gdlr-core-divider-item-normal gdlr-core-item-pdlr gdlr-core-center-align">
                                    <div class="gdlr-core-divider-container" style="max-width: 30px;">
                                        <div class="gdlr-core-divider-line gdlr-core-skin-divider"
                                             style="border-color: #e5b3b3; border-width: 3px;"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="gdlr-core-pbf-element">
                ...
                <div class="gdlr-core-pbf-column gdlr-core-column-20" id="gdlr-core-column-95780">
                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js"
                        ...
                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8" style="">
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-icon-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align" style="padding-bottom: 40px;">
                                    <div class="gdlr-core-icon-item-wrap gdlr-core-skin-e-background gdlr-core-icon-item-type-round" style="background-color: #d34747; border-radius: 40px; -moz-border-radius: 40px; -webkit-border-radius: 40px; padding: 24px 24px 24px 24px;">
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-title-item gdlr-core-item-pdb clearfix gdlr-core-center-align gdlr-core-title-item-caption-top gdlr-core-item-pdlr" style="padding-bottom: 25px;">
                                    <div class="gdlr-core-title-item-title-wrap">
                                        <h3 class="gdlr-core-title-item-title gdlr-core-skin-title" style="font-size: 26px; letter-spacing: 0px; text-transform: none; color: #fff;">
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-divider-item gdlr-core-divider-item-normal gdlr-core-item-pdlr gdlr-core-center-align">
                                    <div class="gdlr-core-divider-container" style="max-width: 30px;">
                                        <div class="gdlr-core-divider-line gdlr-core-skin-divider" style="border-color: #e5b3b3; border-width: 3px;"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="gdlr-core-pbf-element">
                ...
                <div class="gdlr-core-pbf-column gdlr-core-column-20" id="gdlr-core-column-6412">
                    <div class="gdlr-core-pbf-column-content-margin gdlr-core-js" style="padding: 50px 20px 0px 20px;">
                        <div class="gdlr-core-pbf-background-wrap"></div>
                        <div class="gdlr-core-pbf-column-content clearfix gdlr-core-js" data-gdlr-animation-duration="600ms" data-gdlr-animation-offset="0.8" style="">
                            <div class="gdlr-core-pbf-element">
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-text-box-item gdlr-core-item-pdlr gdlr-core-item-pdb gdlr-core-center-align" style="padding-bottom: 0px;">
                                    <div class="gdlr-core-text-box-item-content"
                                         style="text-transform: none; color: #ffffff;">
                                        <p>
                            ...
                            <div class="gdlr-core-pbf-element">
                                <div class="gdlr-core-contact-form-7-item gdlr-core-item-pdlr gdlr-core-item-pdb">
                                    <div role="form" class="wpcf7" id="wpcf7-f1979-p1964-o1" dir="ltr" lang="en-US">
                                        ...
                                        <form method="post" action="https://max-themes.net/demos/corzo/consult/contactform/contactengine.php">
