...
<head>
    ...
    <title>@yield('title') | BarterHub Digital Trading</title>
                    ...
                    <div class="corzo-top-bar-container-inner clearfix">
                        <div class="corzo-top-bar-left corzo-item-pdlr">
                            <div class="corzo-top-bar-left-text">
                                <i class="fa fa-phone" style="font-size: 19px; color: #d32525; margin-right: 10px;"></i>+1754-307-6709
                        ...
                        <div id="text-3" class="widget widget_text corzo-widget">
                            ...
                            <div class="textwidget">
                                <p>
                                    ...
                                    <span style="font-size: 18px; color: #ffffff; font-weight: 600;">+1754-307-6709</span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    (function(){
        ...
        s1.async=true;
        s1.src='https://embed.tawk.to/61f642cb9bd1f31184da0854/1fqkv9rp2';
        s1.charset='UTF-8';
